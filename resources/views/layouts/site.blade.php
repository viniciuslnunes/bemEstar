...
<nav>
    <div class="main-wrapper">
        <div class="flex-container">
            <a class="logotipo" href="{{route('site.categorias')}}">
                <img src="{{asset('images/Asset 1.svg')}}">
            </a>
            <ul class="navigation__itens" id="menu">
                <li>
                    <a href="{{route('site.categorias')}}">Página principal
                        <span class="border-effect"></span>
                    </a>
                </li>
                <li>
                    <a href="{{route('site.categorias')}}">Produtos
                        <span class="border-effect"></span>
                    </a>
                </li>
            </ul>
...
<div id="resize">
    <ul id="menu">
        <li><a class="title-medium" href="{{route('site.categorias')}}">Página principal</a></li>
        <li><a class="title-medium" href="{{route('site.categorias')}}">Produtos</a></li>
    </ul>
</div>
